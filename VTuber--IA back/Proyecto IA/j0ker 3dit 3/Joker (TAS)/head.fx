...
#define EyeLightPower    0.0    // 視線方向での色合いの変化
#define ToonPower        1.0    // 影の暗さ
#define OverBright       1.25    // 白飛び覚悟の明るさ補正
#define FresnelCoef      1.0    // フレネル項の係数
#define FresnelFact      10     // フレネル項
...
#define USE_NORMAL_MAP // 使う? (使わない場合、左に//)
    #define NORMAL_MAP_PATH "dlc12_nightwing_as_head_n.png"
